<div class="trai">
	...
	<ul>		
		<li><a href=""><i class="fa-solid fa-angles-right"></i> For Wholesalers</a></li>
		<li><a href=""><i class="fa-solid fa-angles-right"></i> For Businesses</a></li>
	</ul>	
	<h4><a href="?request=blog">BLOG</a></h4>
	<h4><a href="?request=contact">CONTACT</a></h4>
</div>
