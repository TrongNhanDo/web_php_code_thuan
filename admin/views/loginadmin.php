<?php 
	function loginadmin(){
		...
		if(isset($_POST['loginadmin'])){
			...
			$query = "select * from users where email='$taikhoan' and password='$matkhau'";
			$ketqua = $connect -> query($query);
			if(mysqli_num_rows($ketqua)==false){
				return "Tên đăng nhập hoặc mật khẩu không đúng!";
			}else{
				if($taikhoan=='admin@gmail.com'){
...
<div style="width: 40%;margin: auto;margin-top: 5%">
	...
	<div class="imgcontainer">
		<img src="https://www.shareicon.net/data/512x512/2017/01/06/868320_people_512x512.png" alt="Avatar" class="avatar">
	</div>
